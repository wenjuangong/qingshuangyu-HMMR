...
def test(data_path, label_path, vid=None, graph=None, is_3d=False):
    ...
    if vid is not None:
        ...
        data, label, index = loader.dataset[index]#data = (3,300,25,2) ; label = 56 ; index = 20042
...
if __name__ == '__main__':
    ...
    data_path = "../data/nturgb_d/xsub/train_data_joint.npy"
    label_path = "../data/nturgb_d/xsub/train_label.pkl"
    graph = 'graph.ntu_rgb_d.Graph'
    test(data_path, label_path, vid='S010C001P018R002A057', graph=graph, is_3d=True)
